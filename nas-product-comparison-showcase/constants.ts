import { 
    Cpu, Database, Network, Shield, Server, CreditCard, 
    Zap, HardDrive, Settings, MonitorPlay, Cloud, Lock, 
    Rocket, Gem, Scale, Smartphone
} from 'lucide-react';
import { ProductData, ComparisonRow, RecommendationItem } from './types';
...
export const products: ProductData[] = [
    ...
    },
    {
        ...
        specs: [
            ...
            { icon: Network, label: "网络", value: "10GbE × 1 + 2.5GbE × 1", highlight: true },
...
export const comparisonData: ComparisonRow[] = [
    { parameter: "价格", terra: "约4600元", zspace: "约2699元", ugreen: "2500-2999元", fn: "约1295元" },
    { parameter: "盘位数量", terra: "8盘位 (全闪)", zspace: "4盘位 (混合)", ugreen: "4+2盘位", fn: "6盘位 (全闪)" },
    { parameter: "处理器", terra: "i3-N305 (8核)", zspace: "未明确", ugreen: "Pentium 8505 (5核)", fn: "N150 (4核)" },
    { parameter: "内存", terra: "16GB DDR5", zspace: "8GB DDR5", ugreen: "8GB DDR5", fn: "12GB LPDDR5" },
    { parameter: "存储上限", terra: "64TB", zspace: "120TB", ugreen: "128TB", fn: "48TB" },
    { parameter: "网络", terra: "10GbE × 1", zspace: "2.5GbE × 2", ugreen: "10G + 2.5G", fn: "2.5GbE × 2" },
];
...
export const recommendations: RecommendationItem[] = [
    {
        ...
        icon: Rocket,
        title: "追求极致性能",
        description: "选择铁威马 F8 SSD Plus。8核处理器与10G网络，专为极客和专业用户打造。",
    ...
    },
    {
        ...
        icon: Gem,
        title: "极致性价比",
        description: "选择飞牛零刻 ME mini。千元出头即可拥有全闪6盘位与优秀的fnOS系统。",
    ...
    },
    {
        ...
        icon: Scale,
        title: "均衡之选",
        description: "选择极空间 Z4Pro+。软硬件结合优秀，适合大多数家庭用户的省心之选。",
