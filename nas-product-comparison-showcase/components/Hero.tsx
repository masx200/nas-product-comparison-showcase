...
import { BarChart3, ChevronDown, Database, Zap } from "lucide-react";
  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-brand-dark text-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-brand-dark to-transparent">
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500">
      </div>
    </section>
  );
};
