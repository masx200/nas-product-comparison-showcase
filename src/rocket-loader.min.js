!function () {
  ...
  function a(t, e) {
    ...
    return !(n && !E[n.trim()]) &&
      ((!k || !t.hasAttribute("nomodule")) && !(!k && "module" === n));
  }
  function c(t) {
    return a(t, "");
  }
      ...
      function (n) {
        n.removeAttribute(e),
          Array.prototype.forEach.call(n.attributes, function (e) {
            /^on/.test(e.name) && "function" != typeof n[e.name] &&
  ...
  var A = "http://www.w3.org/2000/svg",
    ...
    I = function () {
      var t = window;
      return t.__rocketLoaderEventCtor ||
        Object.defineProperty(t, "__rocketLoaderEventCtor", {
          value: Event,
        }),
      ...
      return Object.defineProperty(t.prototype, "hasItems", {
        ...
        t.prototype.harvestScripts = function (t, e) {
          var n = this,
            r = e.filter,
            o = e.mutate;
          Array.prototype.slice.call(t.querySelectorAll("script")).filter(r)
    ...
    C = function () {
      ...
      return t.prototype.enable = function (t) {
        ...
        t.prototype.flushWrittenContentAndDisable = function () {
          document.write = L,
            document.writeln = _,
            this.buffer.length && (document.contains(this.insertionPointMarker)
      ...
      return t.prototype.runOnLoad = function (t) {
        ...
        t.prototype.setupEventListenerProxy = function () {
          ...
          ("undefined" != typeof EventTarget
            ...
            : [Node.prototype, Window.prototype]).forEach(function (e) {
    ...
    M = function () {
      var t = window;
      return t.__rocketLoaderLoadProgressSimulator ||
    ...
    W = function () {
      ...
      return t.prototype.insertPreloadHints = function () {
        ...
        t.prototype.finalizeActivation = function (t) {
          this.settings.docWriteSimulator && !t.async &&
        ...
        t.prototype.activateScript = function (t) {
          ...
          return c ? (a.insertBefore(c, r), c) : (e(
