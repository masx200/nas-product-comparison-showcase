!function () {
  var e = {
      ...
      168: function (e, t, n) {
        ...
        t.__esModule = !0;
        var i = n(699), o = n(752), a = n(104), c = n(508);
        !function () {
          function e(e) {
            var t = "";
            if (
              t = window.location.origin
                ...
                : "".concat(window.location.protocol, "://").concat(
              ...
              if (0 === e.indexOf("/")) t += e;
                  ...
                  var n = new URL(e);
                  return "".concat(n.protocol, "://").concat(n.host).concat(
                    n.pathname,
                  );
                } catch (e) {}}
            } else {
          ...
          function t(e, t) {
            for (var n in e) {
              var r = e[n];
              void 0 !== t &&
                ("number" != typeof r && "string" != typeof r || (t[n] = r));
            }
          }
          !function () {
            var n,
              u,
              s = window.performance || window.webkitPerformance ||
              ...
              if (s && p && p.token) {
                ...
                document.addEventListener("visibilitychange", function () {
                  if ("hidden" === document.visibilityState) {
                    if (L && A()) {
                      var t = e();
                      (null == w ? void 0 : w.url) == t &&
                        (null == w ? void 0 : w.triggered) || P(), _(t);
                    }
                    !b && w && (b = !0, B());
                  } else {"visible" === document.visibilityState &&
                      (new Date()).getTime();}
                });
                var E = {};
                ...
                var L = p && (void 0 === p.spa || !0 === p.spa),
                  ...
                  P = function (r) {
                    var a = function (r) {
                      ...
                      return d.firstPaint = k("first-paint"),
                        ...
                        p &&
                        (p.icTag && (d.icTag = p.icTag), d.siteToken = p.token),
                        void 0 !== n && (delete d.timings, delete d.memory),
                        d;
                    }(r);
                    a && p && (a.resources = [],
                      p &&
                      ((0, o.sendObjectBeacon)("", a, function () {}, !1, C),
                        void 0 !== p.forward && void 0 !== p.forward.url &&
                  ...
                  B = function () {
                    var t = function () {
                      var t = s.getEntriesByType("navigation")[0], n = "";
                      try {
                        n = "function" == typeof s.getEntriesByType
                          ? new URL(null == t ? void 0 : t.name).pathname
                          : u
                          ? new URL(u).pathname
                      ...
                      return p &&
                        (p.version && (r.versions.fl = p.version),
                          p.icTag && (r.icTag = p.icTag),
                          r.siteToken = p.token),
                        E &&
                        ["lcp", "fid", "cls", "fcp", "ttfb", "inp"].forEach(
                          function (e) {
                            r[e] = { value: -1, path: void 0 },
                  ...
                  R = function () {
                    var t = window.__cfRl && window.__cfRl.done ||
                ...
                var A = function () {
                  ...
                  _ = function (e) {
                    v.push({ id: l, url: e, ts: (new Date()).getTime() }),
                      v.length > 3 && v.shift();
                  };
                L && (u = e(),
                  function (t) {
            ...
            function x(e) {
              ...
              switch (
                ...
                case "CLS":
                  ...
                  break;
                case "FID":
                  (c = e.attribution) && E.fid &&
                    (E.fid.element = c.eventTarget, E.fid.name = c.eventType);
                  break;
                case "LCP":
                  (c = e.attribution) && E.lcp &&
                    (E.lcp.element = c.element,
                      E.lcp.size = null === (r = c.lcpEntry) || void 0 === r
                        ? void 0
                        : r.size,
                      E.lcp.url = c.url,
                      ...
                      E.lcp.it =
                        null === (i = c.lcpResourceEntry) || void 0 === i
                          ...
                          : i.initiatorType,
                      E.lcp.fp =
                        null === (a = null === (o = c.lcpEntry) || void 0 === o
                              ? void 0
                              : o.element) || void 0 === a
                          ? void 0
            ...
            function I() {
              if (p && p.serverTiming) {
                for (
                  var e = [], t = 0, n = ["navigation", "resource"];
                  t < n.length;
                  t++
                ) {
                  for (
                    var r = n[t], i = 0, o = s.getEntriesByType(r);
                    i < o.length;
                    i++
                  ) {
                    var a = o[i], c = a.name, u = a.serverTiming;
                    if (u) {
                      if ("resource" === r) {
                      ...
                      for (var g = 0, y = u; g < y.length; g++) {
                        var h = y[g],
                          ...
                          S = h.duration;
                        if (
                          p.serverTiming.name && p.serverTiming.name[T]
                        ) {
                          try {
                            var b = new URL(c);
                            e.push({
                              location: "resource" === r
                                ? "".concat(b.origin).concat(b.pathname)
                                : void 0,
                              name: T,
                              dur: S,
                              desc: w,
            ...
            function O(e) {
              if ("function" == typeof s.getEntriesByType) {
                var n = s.getEntriesByType("navigation"), r = {};
                e.timingsV2 = {},
                  n && n[0] &&
                  (n[0].nextHopProtocol &&
                    (r.nextHopProtocol = n[0].nextHopProtocol),
                    n[0].transferSize && (r.transferSize = n[0].transferSize),
                    n[0].decodedBodySize &&
                    (r.decodedBodySize = n[0].decodedBodySize),
            ...
            function k(e) {
              ...
              if ("function" == typeof s.getEntriesByType) {
                var n =
                  null === (t = s.getEntriesByType("paint")) || void 0 === t
                    ? void 0
                    : t.filter(function (t) {
                      return t.name === e;
                    })[0];
          ...
          t.sendObjectBeacon = function (e, t, n, r, i) {
            ...
            if (navigator && "string" == typeof navigator.userAgent) {
              try {
                ...
                c && c[0].toLowerCase().indexOf("chrome") > -1 &&
                  parseInt(c[1]) < 81 && (a = !1);
              } catch (e) {}
            }
            if (
      ...
      104: function (e, t) {
        !function (e) {
          ...
          var t,
            ...
            b = function (e) {
              "hidden" === document.visibilityState && w > -1 &&
            ...
            O = function (e) {
              if (e.cancelable) {
                var t = (e.timeStamp > 1e12 ? new Date() : performance.now()) -
                  e.timeStamp;
                "pointerdown" == e.type
                  ? function (e, t) {
                    var n = function () {
            ...
            z = function () {
              "interactionCount" in performance || o ||
                (o = m("event", q, {
                  type: "event",
                  buffered: !0,
                  durationThreshold: 0,
            ...
            X = {},
            G = function (e) {
              var t = Q[Q.length - 1], n = X[e.interactionId];
            ...
            ee = function (e, t) {
              t = t || {};
              var n = p("TTFB"), r = g(e, n, Z, t.reportAllChanges);
              $(function () {
                var i = a();
                if (i) {
                  ...
                  P(function () {
                    ...
                    var r,
                      ...
                      o = function (e) {
                        ...
                        var t,
                          n =
                            (t = Math.min(Q.length - 1, Math.floor(W() / 50)),
                              Q[t]);
                        n && n.latency !== i.value &&
                    ...
                    var n,
                      ...
                      o = function (e) {
                        ...
                        t && t.startTime < r.firstHiddenTime &&
                          (i.value = Math.max(t.startTime - v(), 0),
                            i.entries = [t],
                            n());
                      },
